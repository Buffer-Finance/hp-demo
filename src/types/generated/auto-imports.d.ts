...
export {}
declare global {
  const ICSocialDiscord: typeof import('~icons/custom/social-discord.tsx')['default']
  const ICSocialTelegram: typeof import('~icons/custom/social-telegram.tsx')['default']
  const ICSocialX: typeof import('~icons/custom/social-x.tsx')['default']
  const ICTokenBTC: typeof import('~icons/custom-token/b-t-c.tsx')['default']
  const ICTokenETH: typeof import('~icons/custom-token/e-t-h.tsx')['default']
  const ICTokenSocialX: (typeof import("~icons/custom-token/social-x.tsx"))["default"]
  const ICTokenSol: typeof import('~icons/custom-token/sol.tsx')['default']
  const ICX: (typeof import("~icons/custom/x.tsx"))["default"]
  const ICustomTokenBTC2: (typeof import("~icons/custom-token/b-t-c2.tsx"))["default"]
